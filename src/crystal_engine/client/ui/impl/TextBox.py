...
class TextBox(UIElement):
    def __init__(self, x, y, w, h, background_image=None, background_color=None, text_color=None, text_font="arial", font_size=16, is_sys_font=True, text="", center_text=True) -> None:
